$(document).ready(function(){
    ...
    function baseurl(){
        ...
        var BaseURL=urlArray[0]+"//"+urlArray[2]+"/codeigniter/acode/";
        return BaseURL; 
...
var url = baseurl()+'admin/report_manager/messagestartout/week';
//var visit = [];
 		var txt = "";
		var mm ="[";
 vv = [];
	 $.ajax({
            ...
            success: function (data) {            	
				...
				coun = dd[xx].msgcount;   
				 ...
				 var mm = [gt(yer,mont,dayd),coun];
				      val.push(mm);
				   }

        url = baseurl()+'admin/report_manager/messagestart_in/week';
         $.ajax({
            url: url,            
            success: function (data) { 
            ...
            error: function (data) {
               ...
               console.log('Data Error, Chart Weekly Outgoing Messages ')
            }
...
//var visit = [ 	[gt(2014, 9, 21), 188], [gt(2014, 9, 22), 205], [gt(2014, 9, 23), 250], [gt(2014, 9, 24), 230], [gt(2014, 9, 25), 245], [gt(2014, 9, 26), 260], [gt(2014, 9, 27), 290]];
...
var url = baseurl()+'admin/report_manager/messagestartout/month';
//var visit = [];
 		var txt = "";
		var mm ="[";
 vv = [];
				...
				coun = dd[xx].msgcount;   
				 ...
				 var mm = [gt(yer,mont,dayd),coun];
				      val.push(mm);
				    	...
				    	// BEGINNNING //
 url = baseurl()+'admin/report_manager/messagestart_in/month';
         $.ajax({
            url: url,            
            success: function (data) { 
...
var url = baseurl()+'admin/report_manager/messagestartout/year														/year';
//var visit = [];
 		var txt = "";
		var mm ="[";
 vv = [];
...
// incoing messages 
url = baseurl()+'admin/report_manager/messagestart_in/year';
         $.ajax({
            url: url,            
            success: function (data) { 
              // alert(data);
