	...
	public function save($pFilename = null)
	{
		if ($this->_spreadSheet !== NULL) {
			...
			for ($i = 0; $i < $this->_spreadSheet->getSheetCount(); ++$i) {
				...
				// Add drawing and image relationship parts1
				...
				// Add comment relationship parts1
				...
				// Add header/footer relationship parts1
