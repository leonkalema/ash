...
foreach($sub_county_info as $row)
{
    $id=$row['id'];
    $sub_county=$row['title'];
        ...
        <form class="form-horizontal" role="form">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" required="" value="<?=ucwords($sub_county)?>" class="form-control" id="county" placeholder="sub county name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select id="district" class="form-control">
                            <option class="text-info" selected="" value="<?=$district?>"><?=ucwords(get_district_by_id($district,'title'))?></option>
                            <?php
