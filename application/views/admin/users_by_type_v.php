                    ...
                    <div class="col-xs-12 col-sm-9 col-lg-10">
                        ...
                        if($all_users_by_type)
                        {
                            ...
                            <div class="messages">
                                <table class="table-condensed message-table" width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tbody>
                                    <?php
                                    foreach($all_users_by_type_paginated as $user)
                                    {
                                        ?>
                                        <tr>
                                            <td>
                                            ...
                                            <td><span class="from"><img class="img-circle pull-left" width="32px" height="32px" src="<?=base_url()?>uploads/avatars/<?=get_thumbnail($user['avatar'])?>"> <a  style="padding: 10px;" href="<?=base_url().$this->uri->segment(1).'/'.$this->uri->segment(2)?>/profile/<?=$user['slug']?>"><?=ucwords($user['fname'].' '.$user['lname'])?></a></span></td>
                                            <td>&nbsp;</td>

                                            <td class="text-right">
                                                <a href="<?=base_url().$this->uri->segment(1).'/'.$this->uri->segment(2)?>/edit/<?=$user['slug']?>"><i class="fa fa-edit text-info"></i></a>
                        ...
                        else
                        {
                            ...
                            <div class="alert alert-dismissable alert-info">
                                ...
                                <p>No users in category to display</p>
